...
func.formatPhoneNumber = number => {
    ...
    if(number.length === 4)return number.substr(0, 2) + '-' + number.substr(2, 2)
    if(number.length === 5)return number.substr(0, 3) + '-' + number.substr(3, 2)
    if(number.length > 3 && number.length < 8)return number.substr(0, 3) + '-' + number.substr(3, 2) + '-' + number.substr(5, number.length)
